  ...
  <div class="container-fluid">
    ...
    <?php
      ...
      if(!empty($_COOKIE['_enter_u_']))
      {
        ...
        $aa = $data->fetch_assoc();
        $name = $aa['name'];
        echo "<small class='text-primary'>| Hi..".$name."</small>";
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <input class="form-control me-2 w-25 search_input" type="search" name="search" placeholder="Search" aria-label="Search" style="box-shadow:0px 0px 5px #007bff;">
      <button class="btn btn-outline-primary search_btn" type="button" style="box-shadow:0px 0px 5px #007bff;">Search</button>
    </div>
  </div>
</nav>